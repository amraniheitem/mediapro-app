...
class _AnimateurDetailleState extends State<VoiceDetailPage> {
  int _rating = 0;
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 8.0),
                            Text(
                              "Anes Mahammedi un Voix off qui vive a mechria wilaya de nàama et j’ai eu plusieurs événements dans plusieurs wilayas.",
                              style: TextStyle(
                                fontSize: 16,
                                color: Colors.black,
                              ),
